	...
	<Layout title={"Authenticate"}>
	  <div className="mt-[10vh]">
		<section className="lg:w-2/6 2xl:w-1/5 bg-white px-10 py-16 mx-auto transition-all">
		  <h1 className="text-6xl font-bold text-neutral-700">Welcome</h1>
		  <p className="mt-3 text-sm text-neutral-500 px-1">
			Use any of the authentication methods below to sign-in or create an account
		  </p>
		  <form onSubmit={handleEmailAuth} className="flex flex-col gap-4 mt-8 transition-all">
