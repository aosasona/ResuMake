  ...
  return (
	<div className="flex flex-col my-1 transition-all">
	  ...
	  <input
		...
		className="bg-neutral-50 text-neutral-700 placeholder-neutral-400 focus:outline-none border border-neutral-600 focus:border-b-primary focus:border-x-0 focus:border-t-0 focus:py-3 focus:bg-transparent focus:px-0 px-6 py-5"
	  />
	</div>
  );
}
