...
const HomeFeature: FC<HomeFeatureProps> = ({title, Icon, url = "", children}) => {
  return (
	...
	>
	  ...
	  <p className="text-neutral-600 text-base leading-loose font-normal">
		{children}
	  </p>

	  <a href={url} className="text-darker hover:text-opacity-50 text-sm font-normal text-right mt-auto underline underline-offset-2 px-2">
		Read more
	  </a>
	</div>
  )
