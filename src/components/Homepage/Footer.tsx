	...
	<footer className="bg-darker px-12">
	  <div className="flex flex-col lg:flex-row lg:justify-evenly gap-10 pt-[10vh] pt-[6vh]">
		<section className="flex flex-col gap-8">
		  <FooterLink title="Try it out" href="/editor"/>
		  <FooterLink title="Blog" href="/blog"/>
		  <FooterLink title="Docs" href="/docs"/>
		</section>
		<section className="flex flex-col gap-8">
		  <FooterLink title="GitHub" newTab={true} href="https://github.com/aosasona/ResuMake"/>
		  <FooterLink title="Twitter" href="#"/>
