...
const Features = () => {
  return (
	<section className="w-[86vw] lg:w-5/6 2xl:w-4/5 lg:h-screen lg:flex lg:items-center mx-auto text-dark pt-16 pb-20">
	  <div>
		<h1 className="space-grotesk text-5xl lg:text-7xl text-left font-bold">Features</h1>
		...
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-7 mt-5 lg:mt-8">
		  ...
		  <HomeFeature title="Open-Source" Icon={BsCodeSlash}>
			You can make your own changes to the code to get features you desire and even self-host your own instance of ResuMake as it is
			publicly available. We are open to contributions and pull requests on our GitHub repository and we will be happy to review them
			and make the product even better for you.
		  </HomeFeature>
